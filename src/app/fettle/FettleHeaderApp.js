                ...
                <div className='h-32 py-4 container mx-auto flex items-center justify-between relative z-10'>
                    ...
                    <div className="relative z-40 flex-1 text-right">
                        <div className={`${open && 'flex' || ''} ${(open === false) && 'hidden' || ''} z-40 px-6 fixed md:relative top-0 left-0 w-full md:w-auto h-screen md:h-auto md:flex flex-col md:flex-row items-center justify-start md:justify-end pt-32 md:pt-0 overflow-y-scroll md:overflow-visible bg-gray-200 text-gray-900 md:text-current md:bg-transparent leading-loose text-cyan-900 text-sm md:text-sm font-semibold tracking-widest hidden uppercase font-heading`}>
                            ...
                            <a href="#"
                               className="text-left block w-full md:w-auto border-b border-gray-300 md:border-none py-4 md:py-0 md:ml-8 hover:opacity-50">About</a>
                            <a href="#"
                               className="text-left block w-full md:w-auto border-b border-gray-300 md:border-none py-4 md:py-0 md:ml-8 hover:opacity-50">Blog</a>
                            <a href="#"
                               className="text-left block w-full md:w-auto border-b border-gray-300 md:border-none py-4 md:py-0 md:ml-8 hover:opacity-50">Portfolio</a>
                            <a href="#"
                               className="text-left block w-full md:w-auto border-b border-gray-300 md:border-none py-4 md:py-0 md:ml-8 hover:opacity-50">Contact</a>
                            <div className='flex md:hidden items-center justify-center my-12'>
                        ...
                        <button className={`${open ? 'hidden' : 'inline-block'} block md:hidden text-4xl font-thin inline-block`} onClick={() => setOpen(true)}>
...
export default FettleHeaderApp;