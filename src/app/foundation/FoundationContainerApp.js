...
export default function FoundationContainerApp(){
    return(
        <React.Fragment>
            ...
            <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 py-24">
                <div className="lg:px-32 lg:py-32 flex items-center justify-center">
                    <div>
                        ...
                        <a href="#" className="mt-8 inline-block rounded-full border-2 border-gray-900 text-lg px-8 py-3 hover:bg-black hover:text-white">
                            Our Promise</a>
                    </div>
                </div>
                <div className="hidden lg:grid relative grid-cols-2">
                    ...
                    <div className="relative">
                        <img
                            src="https://images.unsplash.com/photo-1535732759880-bbd5c7265e3f?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"
            ...
            <div className="mx-auto max-w-lg text-center py-24">
                ...
                <p className="text-xl">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                    incididunt ut labore et dolore magna aliqua.</p>
            </div>
            <div className="flex flex-wrap md:space-x-12 justify-center px-4">
                <a href="#" className="block w-full md:flex-1 max-w-xs mb-12">
                    <img
                        src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2550&q=80"
                        className="w-full h-96 object-cover"
                        alt=''
                        loading='lazy'
                    />
                    <div className="text-lg text-center p-4">Service Title</div>
                </a>
                <a href="#" className="block w-full md:flex-1 max-w-xs mb-12">
                    <img
                        src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2550&q=80"
            ...
            <div className="relative w-full bg-black py-32 my-12 lg:my-24">
                <div className="relative z-10 text-center text-white text-center mx-auto max-w-xl">
                    <h1 className="text-3xl lg:text-7xl mb-4 font-bold uppercase italic">Property Development</h1>
                    <a href="#" className="inline-block rounded-full border-2 border-white text-lg px-8 py-3 hover:bg-white hover:text-gray-900">
                        Find out more
                    </a>
                </div>
                <img
                    src="https://images.unsplash.com/photo-1448630360428-65456885c650?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=2547&q=80"
