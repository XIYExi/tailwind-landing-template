...
function VoyageHeaderApp(){


    return (
        <React.Fragment>
            <div className='bg-yellow-600 bg-opacity-50 text-white text-xs text-center uppercase tracking-widest px-6 py-2'>
                Introducing our new help kit we just launched.&nbsp;
                <a href="#" className="underline">Download Now</a>
            </div>
...
export default VoyageHeaderApp;
